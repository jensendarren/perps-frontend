  ...
  if (position) {
    ...
    if (isDeposit) {
      ...
      if (fromAmount) {
        ...
        convertedAmountFormatted = formatAmount(convertedAmount, USD_DECIMALS, USD_DISPLAY_DECIMALS);
      }
    } else {
      fromAmount = parseValue(fromValue, USD_DECIMALS);
      maxAmount = position.collateral;
      maxAmountFormatted = formatAmount(maxAmount, USD_DECIMALS, position.indexToken.displayDecimals, true);
      maxAmountFormattedFree = formatAmountFree(maxAmount, USD_DECIMALS, position.indexToken.displayDecimals);
      if (fromAmount) {
